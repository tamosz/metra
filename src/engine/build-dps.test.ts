...
let _nightLordData: ClassSkillData;
let _nightLordHigh: CharacterBuild;
...
beforeAll(() => {
  ...
  _nightLordData = loadClassSkills('night-lord');
  _nightLordHigh = loadGearTemplate('night-lord-high');
});
